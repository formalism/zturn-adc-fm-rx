...
set_property PACKAGE_PIN D20 [get_ports I2C_SDA_B]
set_property PACKAGE_PIN B20 [get_ports I2C_SCL_B]
...
# CN2
set_property PACKAGE_PIN K17 [get_ports ADC_CK_B]
set_property PACKAGE_PIN H16 [get_ports {AD_B[11]}]
set_property PACKAGE_PIN J18 [get_ports {AD_B[10]}]
set_property PACKAGE_PIN L17 [get_ports {AD_B[9]}]
set_property PACKAGE_PIN K18 [get_ports {AD_B[8]}]
set_property PACKAGE_PIN L20 [get_ports {AD_B[7]}]
set_property PACKAGE_PIN L19 [get_ports {AD_B[6]}]
set_property PACKAGE_PIN M17 [get_ports {AD_B[5]}]
set_property PACKAGE_PIN F17 [get_ports {AD_B[4]}]
set_property PACKAGE_PIN E18 [get_ports {AD_B[3]}]
set_property PACKAGE_PIN F16 [get_ports {AD_B[2]}]
set_property PACKAGE_PIN D18 [get_ports {AD_B[1]}]
set_property PACKAGE_PIN E17 [get_ports {AD_B[0]}]
set_property PACKAGE_PIN H17 [get_ports OFA_B]
set_property PACKAGE_PIN F19 [get_ports MUX_B]
set_property PACKAGE_PIN F20 [get_ports SHDNA_B]
set_property PACKAGE_PIN M20 [get_ports SHDNB_B]
set_property PACKAGE_PIN B19 [get_ports I2S_FS_B]
set_property PACKAGE_PIN A20 [get_ports I2S_BCLK_B]
set_property PACKAGE_PIN C20 [get_ports I2S_DAT_B]
set_property PACKAGE_PIN D19 [get_ports DAC_MCLK_B]

set_property IOSTANDARD LVCMOS33 [get_ports ADC_CK_B]
set_property IOSTANDARD LVCMOS33 [get_ports {AD_B[*]}]
set_property IOSTANDARD LVCMOS33 [get_ports SHDNA_B]
set_property IOSTANDARD LVCMOS33 [get_ports SHDNB_B]
set_property IOSTANDARD LVCMOS33 [get_ports MUX_B]
set_property IOSTANDARD LVCMOS33 [get_ports OFA_B]
set_property IOSTANDARD LVCMOS33 [get_ports I2S_FS_B]
set_property IOSTANDARD LVCMOS33 [get_ports I2S_BCLK_B]
set_property IOSTANDARD LVCMOS33 [get_ports I2S_DAT_B]
set_property IOSTANDARD LVCMOS33 [get_ports DAC_MCLK_B]

create_clock -period 25.000 -name adck [get_ports ADC_CK]
create_clock -period 25.000 -name adck_b [get_ports ADC_CK_B]
set_clock_groups -asynchronous -group adck -group adck_b
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets w_adc_ck_bufg]
